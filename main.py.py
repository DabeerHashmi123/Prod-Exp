...
import sys
import os
from PyQt5.QtWidgets import QApplication, QMainWindow, QAction, QToolBar, QMessageBox, QStatusBar, QTableWidget, QTableWidgetItem, QFileDialog, QInputDialog, QWidget, QVBoxLayout, QPushButton, QLabel, QHBoxLayout, QLineEdit,QListWidgetItem,QListWidget,QDialog,QAbstractItemView 
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        db_path = r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\new_database1.db"
        ...
        self.setWindowIcon(QIcon(r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\notification-icon-bell-alarm.jpg"))
        self.setMinimumSize(1024, 768)

        toolbar = QToolBar()
        self.addToolBar(toolbar)

        import_data_action = QAction(QIcon(r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\add-product.png"), "Import Data", self)
        import_data_action.triggered.connect(self.import_data)
        toolbar.addAction(import_data_action)

        search_action = QAction(QIcon(r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\s1.png"), "Search", self)
        search_action.triggered.connect(self.search)
        toolbar.addAction(search_action)

        refresh_action = QAction(QIcon(r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\r3.png"), "Refresh", self)
        refresh_action.triggered.connect(self.refresh_data)  # Change this to self.refresh_data
        toolbar.addAction(refresh_action)
        
        near_expiry_action = QAction(QIcon(r'C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\download.png'), "Near Expiry Products", self)
        near_expiry_action.triggered.connect(self.show_near_expiry_list)
        toolbar.addAction(near_expiry_action)

        delete_action = QAction(QIcon(r"C:\Users\sabih\Downloads\P-E-N-S-main\P-E-N-S-main\d1.png"), "Delete", self)
...
""")
    ...
    def import_data(self) -> None:
        ...
        for row in sheet.iter_rows(min_row=2, values_only=True):
                    ...
                    expiry_date = row[column_mapping.get('Expiry Date') - 1] 
                    # Assuming expiry_date is fetched as a date object
                    try:
                       self.cur.execute(
